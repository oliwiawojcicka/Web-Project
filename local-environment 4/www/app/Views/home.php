    ...
    <div class="feed-container container">
        ...
        <section class="create-post-box">
            ...
            <form action="/posts" method="post" enctype="multipart/form-data">
                ...
                <!-- ZMIANA TUTAJ: dodano rows="4" oraz maxlength="500" -->
                <textarea id="home-content" name="content" rows="4" maxlength="500" placeholder="..."><?= old('content') ?></textarea>
                    ...
                    <article class="post-card" data-post-id="<?= esc($post['id']) ?>">
                        <div class="post-header">
                            ...
                            <div>
                                ...
                                <!-- ZMIANA TUTAJ: dodano atrybut title dla lepszej dostępności -->
                                <small title="<?= lang('App.date_published_title') ?? 'Published date' ?>"><?= esc($post['created_at']) ?></small>
                            </div>
                        </div>
